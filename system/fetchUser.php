        ...
        while ($fetchUserRow = mysqli_fetch_assoc($fetchUserQuery)) {
            $fetchOutput .= "
              <tr class='table__data'>
                ...
                <td class='table__data--items'>{$fetchUserRow['username']}</td>
                <td class='table__data--items'>{$fetchUserRow['designation']}</td>
                <td class='table__data--items'>{$fetchUserRow['user_role']}</td>
                <td class='table__data--items'>{$fetchUserRow['status']}</td>
